...
internal sealed class WindowsPtyConnection : IPtyConnection
{
        ...
        int cols)
    {
        ...
        try
        {
            ...
            {
                throw CreateWin32Exception($"Failed to create process '{app}'.");
            }
    ...
    public bool WaitForExit(int milliseconds)
    {
        ...
        throw CreateWin32Exception("Failed while waiting for the process to exit.");
    }
    ...
    public void Kill()
    {
        ...
        if (!NativeMethods.TerminateProcess(this.processHandle, 1))
        {
            ...
            {
                throw new InvalidOperationException(
                    $"Failed to terminate process {this.Pid} (error={error}).");
            }
        }
    }
