...
public static class WindowSettingsPersistence
{
    ...
    /// <param name="settings">Window geometry settings.</param>
    public static void Apply(Window window, IWindowGeometrySettings settings)
    {
    ...
    /// <param name="settings">Window geometry settings.</param>
    public static void Capture(Window window, IWindowGeometrySettings settings)
    {
